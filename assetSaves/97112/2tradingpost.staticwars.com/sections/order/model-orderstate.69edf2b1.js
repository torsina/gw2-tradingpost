YUI.add("model-orderstate", function(t) {
    ...
    e = {
        itemCountByDataId: function(t) {
            return h.stats.inventory.reduce(function(e, s) {
                return s.dataId === t ? e + s.count : e
            }, 0)
        },
        itemByDataId: function(t) {
            var e;
            return h.stats.inventory.some(function(s) {
        ...
        initializer: function() {
            this.maxUnitPrice = new s.Coins({
                maxAmount: 1e8
            }), this.listings = new s.Listings, this._eventHandles = [h.stats.after("inventoryChange", this._onPlayerOwnedChange, this), this.after("quantityChange", this._validateChange, this), this.maxUnitPrice.after("amountChange", this._validateChange, this), this.maxUnitPrice.after("amountTooLowChange", function(t) {
        ...
        _validateChange: function(t) {
            var e, s;
            t.silent || (this._checkListings(), e = this.get("totalPrice"), s = this.get("listingFee"), "buy" === this.get("buyOrSell") ? e > h.stats.coins ? this.set("message", {
                kind: "error",
                msg: "transactions.error.cost"
            }) : "transactions.error.cost" === this.get("message").msg && this.set("message", !1) : s > h.stats.coins ? this.set("message", {
                kind: "error",
        ...
        fetchItem: function(e, s) {
            ...
            return isNaN(i) ? t.Promise.reject("Invalid id: " + i) : "whitelisted" in e && !e.whitelisted ? (this.fire("restricted"), t.Promise.reject("Item restricted")) : (s || (s = {}), o.inject(i), this.set("oldMessages", []), this.set("message", !1, {
                force: !0
            }), s.skipListings || this.listings.load({
                dataId: i
            }, this._listingsFetched.bind(this, !0)), h.call("QueryItemInfo", {
                items: [i]
        ...
        execute: function() {
            ...
            }) : (this.set("uiLocked", !0), "buy" === t ? this._executeBuy() : (s = e.itemByDataId(s.dataId)) ? this.get("listingFee") > h.stats.coins ? this.set("message", {
                kind: "error",
                heading: "transactions.headings.error",
                msg: "transactions.error.listingfee",
        ...
        _executeSell: function() {
            ...
            return (s = e.itemByDataId(s.dataId)) ? this.get("listingFee") > h.stats.coins ? this.set("message", {
                kind: "error",
                heading: "transactions.headings.error",
                msg: "transactions.error.listingfee",
                callback: this.set.bind(this, "uiLocked", !1),
                duration: 1 / 0
            }) : (this.get("instant") && this.maxUnitPrice.set("amount", this.listings.get("buys")[0].unitPrice), void h.call("SellItem", {
        ...
        _executeBuy: function() {
            ...
            if (this.get("isAsk") || (e.CustomOffer = "whole twelve bananas"), this.get("totalPrice") > h.stats.coins) return this.set("message", {
                kind: "error",
                heading: "transactions.headings.error",
                msg: "transactions.error.cost",
                callback: this.set.bind(this, "uiLocked", !1),
        ...
        _onError: function(t) {
            ...
            if ("spamming" === t.response) s.msg = "transactions.error.ratelimit";
                ...
                t.code && (c[t.code] ? s.msg = c[t.code] : a.netError(t))
            }
        ...
        _onFetchItem: function(t, s) {
            var n, r, o = this,
                ...
                g = 250;
            if (h) {
                if (h.vendor = h.vendor || 0, h.rarityAttr = i.reverse("Rarity", h.rarity), "ENCRYPTED_STRING" === h.name || !h.name) return this.setAttrs({
                    uiLocked: !0,
                    itemLoaded: !1
                }), u.load({
                    type_id: h.itemType,
        ...
        ATTRS: {
            ...
            canAfford: {
                getter: function() {
                    return "buy" === this.get("buyOrSell") ? this.get("totalPrice") <= h.stats.coins : this.get("listingFee") <= h.stats.coins
                }
            },
            quantityTooLow: {
                setter: function(t) {
